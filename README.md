...
NH-HAZE and DENSE-HAZE are comprised of real haze generated that are of non-homogeneous and dense nature, while O-HAZE is comprised of real haze generated that ensures homogenity in the image captured. For RESIDE, we used the SOTS subset for evaluation.
